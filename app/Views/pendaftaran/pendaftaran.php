        ...
        <div class="col-md-6 right-section">
            ...
            <div class="card p-3 custom-card">
                ...
                <form action="<?= base_url('daftar-member') ?>" method="post">
                    ...
                    <!-- Kategori Lainnya -->
                    <div class="form-group">
                        <label for="kategori_lainnya"><?= lang('Blog.kategorilainnya'); ?></label>
                        <textarea id="kategori_lainnya" name="kategori_lainnya" placeholder="<?= lang('Blog.placeholderkategorilainnya'); ?>"><?= old('kategori_lainnya') ?></textarea>
                    </div>
                    ...
                    <div class="form-group fullwidth">
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="agree_terms">
                                Saya telah membaca, mengerti dan menyetujui
                                <a href="<?= base_url('syarat-ketentuan'); ?>" target="_blank" class="link-syarat">
                                    syarat dan ketentuan
                                </a> penggunaan layanan ini.
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="form-group fullwidth">
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="syarat2">
                                Saya yakin dengan data yang saya masukkan.
                            </label>
                        </div>
                    </div>
