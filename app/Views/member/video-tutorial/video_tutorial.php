                ...
                <div class="submenu">
                    <?php if (!empty($kategori_video)): ?>
                        <div class="submenu-item">
                            <a href="<?= base_url(('/video')); ?>" class="submenu-link <?= empty($active_category) ? 'active' : ''; ?>">
                                <?= lang('Blog.filterAllPlaceholder') ?>
                            </a>
                        </div>
                        <?php foreach ($kategori_video as $item): ?>
                            <div class="submenu-item">
                                <a href="<?= base_url(( 'video/') . $item['slug']); ?>" class="submenu-link <?= $active_category == $item['id_kategori_video'] ? 'active' : ''; ?>">
                    ...
                    <div class="card h-100 shadow-sm">
                        ...
                        <div class="card-body d-flex flex-column">
                            <div class="mb-3 d-flex justify-content-between align-items-center">
                                ...
                                <span class="badge"><?= $video['nama_kategori_video']; ?></span>
                            </div>
                            ...
                            <!-- tombol readmore -->
                            <a href="<?= base_url(( 'video/') . ($video['slug'])); ?>" class="btn btn-custom mt-auto">
                                <?= lang('Blog.watchNow') ?>
                            </a>
                        </div>
                    </div>
