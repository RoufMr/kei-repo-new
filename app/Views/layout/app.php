                    ...
                    <?php if (session()->get('logged_in')): ?>
                        <?php if (session()->get('role') == 'admin'): ?>
                            <a href="<?= base_url('/admin-dashboard') ?>">
                                <button type="button" class="btn btn-outline-light"><?= session()->get('username') ?></button>
                            </a>
                        <?php endif; ?>
                        <a href="<?= base_url('/logout') ?>">
                            <button type="button" class="btn btn-outline-light"><?php echo lang('Blog.headerKeluar'); ?></button>
                        </a>
                    <?php else: ?>
                        <a href="<?= base_url('/login') ?>">
                            <button type="button" class="btn btn-outline-light login"><?php echo lang('Blog.headerMasuk'); ?></button>
                        </a>
                    <?php endif; ?> -->
